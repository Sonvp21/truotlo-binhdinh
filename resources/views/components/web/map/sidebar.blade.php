<div class="z-20 bg-white shadow-[6px_0_6px_-7px_#333]">
    ...
    >
        <div class="flex h-16 items-center justify-between px-4">
            <h2 class="text-2xl font-bold">KTTV</h2>
            <div
                x-on:click="sidebar = ! sidebar"
                class="cursor-pointer rounded bg-slate-50 p-1 hover:bg-slate-200"
            >
        ...
        <div x-data="{ open: true }">
            ...
            >
                ...
                <svg
                    ...
                    class="h-4 w-4"
                >
                    <path x-cloak x-show="open" fill-rule="evenodd" d="M11.47 7.72a.75.75 0 011.06 0l7.5 7.5a.75.75 0 11-1.06 1.06L12 9.31l-6.97 6.97a.75.75 0 01-1.06-1.06l7.5-7.5z" clip-rule="evenodd" /><path x-show="!open" fill-rule="evenodd" d="M12.53 16.28a.75.75 0 01-1.06 0l-7.5-7.5a.75.75 0 011.06-1.06L12 14.69l6.97-6.97a.75.75 0 111.06 1.06l-7.5 7.5z" clip-rule="evenodd" />
                </svg>
            </div>
            <ul
                x-cloak
    ...
    >
        <span
            x-on:click="sidebar = ! sidebar"
            class="absolute -right-4 top-8 flex cursor-pointer rounded-full border border-sky-500 bg-sky-700 p-1 hover:bg-sky-800"
            title="Show sidebar"
        >
