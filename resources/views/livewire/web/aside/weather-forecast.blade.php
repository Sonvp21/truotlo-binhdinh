                ...
                <div class="bg-white p-2" wire:loading.class="opacity-60">
                    ...
                    <div class="mt-2 p-2">
                        <div class="flex gap-2">
                            <div class="flex gap-2">
                                <img class="m-auto" src="{{ $currentForecast->icon_code }}" alt=""/>
                                <div class="flex items-center">
                                    <div class="flex flex-col">
                                        ...
                                        <div class="flex flex-col whitespace-nowrap text-xs text-gray-700">
                                            <div><b>@lang('web.humidity')</b>: {{ $currentForecast->humidity }}%</div>
                                            <div><b>@lang('web.wind')</b>: {{ $currentForecast->wind_speed }} km/h</div>
