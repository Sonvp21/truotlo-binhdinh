            ...
            <div class="mt-6">
                <form action="" class="space-y-4">
                    <h3 class="flex items-center gap-2 font-bold">
                        <div style="width: 20px">{{ svg('heroicon-o-user') }}
                            </div>
                        Nhập thông tin liên hệ
                    </h3>
                    <div class="ml-1.5 space-y-4 border-l-4 border-sky-500 pl-4">
                        <div class="flex flex-col">
                            <label class="text-sm text-slate-700" for="name">Họ và tên<sup
                                    class="text-red-500">*</sup></label>
                            <input type="text" id="name" name="name"
                                class="rounded border border-slate-300 px-4 text-sm" required />
                        </div>
                        <div class="flex flex-col">
                            <label class="text-sm text-slate-700" for="email">Email<sup
                                    class="text-red-500">*</sup></label>
                            <input type="text" id="email" name="email"
                                class="rounded border border-slate-300 px-4 text-sm" required />
                        </div>
                        <div class="flex flex-col">
                            <label class="text-sm text-slate-700" for="phone">Số điện thoại<sup
                                    class="text-red-500">*</sup></label>
                            <input placeholder="(+84)" type="text" id="phone" name="phone"
                                class="rounded border border-slate-300 px-4 text-sm" required />
                        </div>
                        <div class="flex flex-col">
                            <label class="text-sm text-slate-700" for="message">Nội dung liên hệ<sup
                                    class="text-red-500">*</sup></label>
                            <textarea type="text" id="message" name="message" rows="6"
                                class="rounded border border-slate-300 px-4 text-sm" required></textarea>
                        </div>
